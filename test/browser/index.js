...
},{"./lib/cockblock":2}],2:[function(require,module,exports){
(function (global){
...
},{"./chai/assertion":6,"./chai/config":7,"./chai/core/assertions":8,"./chai/interface/assert":9,"./chai/interface/expect":10,"./chai/interface/should":11,"./chai/utils":22,"assertion-error":3}],6:[function(require,module,exports){
/*!
 * chai
 * http://chaijs.com
 * Copyright(c) 2011-2014 Jake Luer <jake@alogicalparadox.com>
...
},{"./addChainableMethod":12,"./addMethod":13,"./addProperty":14,"./flag":15,"./getActual":16,"./getMessage":18,"./getName":19,"./getPathValue":20,"./inspect":23,"./objDisplay":24,"./overwriteChainableMethod":25,"./overwriteMethod":26,"./overwriteProperty":27,"./test":28,"./transferFlags":29,"./type":30,"deep-eql":31}],23:[function(require,module,exports){
...
describe("cockblock()", function() {
  function html(given, expected) {
    ...
    return function() { expect(cockblock(given), given).to.eql(expected); };
  }

  function url(given, expected) {
    if (arguments.length == 1) expected = given;
    return function() { expect(cockblock.url(given), given).to.eql(expected); };
  }
  ...
  // TODO: Add test for each attach, possibly as a general cockblock test suite driver
...
describe("sanitizeAttributes()", function() {
  ...
  it("handles undefined attributes", function() {
    expect(function() {
      ...
      cockblock._sanitizeAttributes($el, cockblock.defaults);
    }).to.not.throw();
  });
  ...
  it("only iterates on own properties", function() {
    ...
    cockblock._sanitizeAttributes($el, options);
...
describe("getAttributeName()", function() {
  describe("with numeric index (jquery/browser)", function() {
    ...
    it("returns name", function() {
      expect(cockblock._getAttributeName(attributes, 0)).to.eql("class");
      expect(cockblock._getAttributeName(attributes, "0")).to.eql("class");
    });

    // Issue #1
    it("handles undefined attributes", function() {
      expect(cockblock._getAttributeName(attributes, "1")).to.eql(undefined);
    });
  });
  ...
  describe("with named index (node/cheerio)", function() {
    ...
    it("returns name", function() {
      expect(cockblock._getAttributeName(attributes, "class")).to.eql("class");
    });
  });
});

},{"..":1,"chai":4}],36:[function(require,module,exports){
'use strict'
